...
class QPushButtomDemo(QDialog):
    def __init__(self):
        super(QPushButtomDemo, self).__init__()
        self.initUI()
    ...
    def initUI(self):
        ...
        self.button1.clicked.connect(lambda:self.\
        ...
        self.button4.clicked.connect(lambda:\
