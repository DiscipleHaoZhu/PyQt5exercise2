...
class ClipBoard(QDialog):
    def __init__(self):
        ...
        textCopButton = QPushButton('复制文本')
        ...
        self.imageLabel.setPixmap(QPixmap('../Images/board.jpg'))

        layout = QGridLayout()
        layout.addWidget(textCopButton,0,0)
        ...
        textCopButton.clicked.connect(self.copyText)
    ...
    def copyText(self):
        clipboar = QApplication.clipboard()
        clipboar.setText('Hello word!')
    ...
    def copyImage(self):
        clipboard = QApplication.clipboard()
        clipboard.setPixmap(QPixmap('../Images/floor tile1.jpg'))
